...
public class PrestitiController implements Initializable {
    ...
    public static String matricolaDaRicercareAutom = null;
    @FXML
    private TabPane tabPanePrestiti;
    @FXML
    private TextField prestitoMatricolaField;
    @FXML
    private TextField prestitoIsbnField;
    @FXML
    ...
    @FXML
    private TableColumn<Prestito, LocalDate> colScadenza;
    @FXML
    private ComboBox<String> prestitiMatricolaCombo;
    @FXML
    private ComboBox<String> prestitiIsbnCombo;
    @FXML
    private TextField searchPrestitoField;
    @FXML
    private TableView<Prestito> tablePrestitiAttivi;
    @FXML
    private ComboBox<String> filtroPrestitiCombo;
    @FXML
    private TextField searchVisualizzazioneField;
    @FXML
    private TableView tableVisualizzazione;
    ...
    @FXML
    private void handleConfermaPrestito(ActionEvent event) {
        if (isInputValido()) {
    ...
    @FXML
    private void handleRegistraRestituzione(ActionEvent event) {
    ...
    @FXML
    private void handleResetPrestiti(ActionEvent event) {
        try {
